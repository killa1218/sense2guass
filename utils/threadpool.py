...
class WorkerThread(multiprocessing.Process):
    ...
    def __init__(self, requests_queue, results_queue, poll_timeout=5, **kwds):
        ...
        """
        super(WorkerThread, self).__init__(**kwds)
        self.daemon = True
        self._requests_queue = requests_queue
        self._results_queue = results_queue
        self._poll_timeout = poll_timeout
        self._dismissed = multiprocessing.Event()
        self.start()
...
class ThreadPool:
    ...
    def __init__(self, num_workers, q_size=0, resq_size=0, poll_timeout=5):
        ...
        """
        self._requests_queue = multiprocessing.Queue(q_size)
        self._results_queue = multiprocessing.Queue(resq_size)
        self.workers = []
